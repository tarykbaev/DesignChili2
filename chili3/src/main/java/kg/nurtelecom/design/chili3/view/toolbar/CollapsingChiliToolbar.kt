package kg.nurtelecom.design.chili3.view.toolbar
...
import kg.nurtelecom.design.chili3.databinding.ChiliViewCollapsingToolbarBinding
import kg.nurtelecom.design.chili3.R.style.*
...
class CollapsingChiliToolbar @JvmOverloads constructor(
    ...
    private fun obtainAttributes(attrs: AttributeSet, defStyle: Int = Chili_CollapseToolbarView) {
        context?.obtainStyledAttributes(attrs, R.styleable.CollapsingChiliToolbar, kg.nurtelecom.design.chili3.R.attr.CollapsingToolbarDefaultStyle, defStyle)?.run {
