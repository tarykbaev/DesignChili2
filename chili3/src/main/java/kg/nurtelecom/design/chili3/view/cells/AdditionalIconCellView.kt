...
import kg.nurtelecom.design.chili2.view.cells.BaseCellView
import kg.nurtelecom.design.chili3.extensions.isVisible
...
@JvmOverloads constructor(
    ...
    override fun obtainAttributes(
        ...
        context.obtainStyledAttributes(
            attrs,
            kg.nurtelecom.design.chili3.R.styleable.AdditionalIconCellView,
            defStyleAttr,
            defStyleRes
        ).run {
            getString(kg.nurtelecom.design.chili3.R.styleable.AdditionalIconCellView_tag_text)?.let {
                setTagText(it)
            }
            getResourceId(
                kg.nurtelecom.design.chili3.R.styleable.AdditionalIconCellView_tag_icon,
                -1
            ).takeIf { it != -1 }?.let {
                setTagIcon(it)
            }
            getResourceId(
                kg.nurtelecom.design.chili3.R.styleable.AdditionalIconCellView_tag_background,
                -1
            ).takeIf { it != -1 }?.let {
                setTagBackground(it)
            }
