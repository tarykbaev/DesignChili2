package kg.nurtelecom.design.chili3.view.cells
...
import kg.nurtelecom.design.chili2.extensions.dpF
import kg.nurtelecom.design.chili2.extensions.setImageByUrl
import kg.nurtelecom.design.chili2.extensions.setImageOrHide
import kg.nurtelecom.design.chili2.extensions.setTextOrHide
import kg.nurtelecom.design.chili2.extensions.setupAsSecure
import kg.nurtelecom.design.chili3.R
import kg.nurtelecom.design.chili2.view.shimmer.ShimmeringView
import com.facebook.shimmer.ShimmerFrameLayout
import kg.nurtelecom.design.chili3.databinding.ChiliViewCardCellBinding
import kg.nurtelecom.design.chili3.extensions.getColorFromAttr
import kg.nurtelecom.design.chili3.extensions.setBoldTextWeight
import kg.nurtelecom.design.chili3.extensions.setNormalTextWeight
import kg.nurtelecom.design.chili3.extensions.setSurfaceClick
import kg.nurtelecom.design.chili3.extensions.visible

class CardCellView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = kg.nurtelecom.design.chili2.R.attr.cardCellViewDefaultStyle,
    defStyleRes: Int = kg.nurtelecom.design.chili2.R.style.Chili_CellViewStyle_CardCellView
    ...
    fun setIsBlocked(
        ...
        errorTextColor: Int = context.getColorFromAttr(kg.nurtelecom.design.chili2.R.attr.ChiliErrorTextColor)
    ) {
        with(vb) {
    ...
    fun setIsUniqueStated(
        ...
        uniqueColor: Int = context.getColorFromAttr(kg.nurtelecom.design.chili2.R.attr.ChiliErrorTextColor),
        defaultColorSubtitle: Int = context.getColorFromAttr(kg.nurtelecom.design.chili2.R.attr.ChiliValueTextColor),
        defaultColorAdditional: Int = context.getColorFromAttr(kg.nurtelecom.design.chili2.R.attr.ChiliPrimaryTextColor)
    ) {
        with(vb) {
            if (isUniqueStated) {
