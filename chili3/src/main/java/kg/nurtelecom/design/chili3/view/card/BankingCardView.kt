package kg.nurtelecom.design.chili3.view.card
...
import kg.nurtelecom.design.chili2.extensions.color
import kg.nurtelecom.design.chili2.extensions.dp
import kg.nurtelecom.design.chili2.extensions.drawable
import kg.nurtelecom.design.chili2.extensions.setImageByUrl
import kg.nurtelecom.design.chili2.extensions.setTopMargin
import kg.nurtelecom.design.chili2.view.card.BaseCardView
import kg.nurtelecom.design.chili2.view.card.CardFieldToggleState
import kg.nurtelecom.design.chili3.databinding.ChiliBankingCardViewBinding
import kg.nurtelecom.design.chili3.extensions.gone
import kg.nurtelecom.design.chili3.extensions.invisible
...
class BankingCardView @JvmOverloads constructor(
    ...
    fun startBgShimmer() = with(vb) {
        ...
        setPanBackgroundTint(kg.nurtelecom.design.chili3.R.color.c_c4c4c4_alpha_70)
        setCvvBackgroundTint(kg.nurtelecom.design.chili3.R.color.c_c4c4c4_alpha_70)
        ivCardBg.gone()
    }
