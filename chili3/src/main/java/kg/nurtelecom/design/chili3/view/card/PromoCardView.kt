...
import kg.nurtelecom.design.chili3.databinding.ChiliViewCardPromoBinding
import kg.nurtelecom.design.chili3.extensions.getDimensionFromAttr
import kg.nurtelecom.design.chili3.util.PromoStatus
...
class PromoCardView @JvmOverloads constructor(
    ...
    fun setStatus(status: Int) {
        when (status) {
            ...
            PromoStatus.APPROVED.value -> setStatusBackground(R.drawable.chili_bg_promo_status_aprroved_gradient)
