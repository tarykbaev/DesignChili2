...
import kg.nurtelecom.design.chili2.extensions.setIsSurfaceClickable
...
import kg.nurtelecom.design.chili3.databinding.ChiliViewCardAccountBinding
...
import kg.nurtelecom.design.chili2.R as R2
...
class AccountCardView @JvmOverloads constructor(
    ...
    private fun updateToggleIcon() {
        vb.ivToggleIcon.setImageResource(
            if (isToggleHiddenState) R.drawable.chili_ic_eye_slash
            else R.drawable.chili_ic_eye
        )
    }
