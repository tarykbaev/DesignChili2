...
import kg.nurtelecom.design.chili3.databinding.ChiliViewSimpleTextChipBinding
...
open class ChiliSimpleTextChipVH : ChiliChipViewHolder() {
    ...
    override fun setupAsUnselected() {
        ...
        vb.root.apply {
            isSelected = false
            setTextColor(context.getColorFromAttr(kg.nurtelecom.design.chili2.R.attr.ChiliPrimaryTextColor))
        }
    }
