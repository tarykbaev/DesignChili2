package kg.nurtelecom.design.chili3.view.common
...
class CustomBottomNavigationView(context: Context, attributeSet: AttributeSet)
    ...
    private fun getNotifierLayoutParams(): LayoutParams {
        return LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT).apply {
            ...
            leftMargin = resources.getDimension(kg.nurtelecom.design.chili2.R.dimen.padding_8dp).toInt()
            topMargin = resources.getDimension(kg.nurtelecom.design.chili2.R.dimen.padding_8dp).toInt()
        }
    }
