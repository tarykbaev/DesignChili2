...
import kg.nurtelecom.design.chili3.databinding.ChiliViewCardStateIconBinding
...
class IconStateCardView @JvmOverloads constructor(
    ...
    fun clearErrorState() {
        setIcon(null)
        vb.rootView.setBackgroundColor(context.getColorFromAttr(kg.nurtelecom.design.chili2.R.attr.ChiliCardViewBackground))
    }
}