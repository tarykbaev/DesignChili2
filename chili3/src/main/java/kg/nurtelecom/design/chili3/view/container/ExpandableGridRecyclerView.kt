package kg.nurtelecom.design.chili3.view.container
...
import kg.nurtelecom.design.chili3.adapter.GridSpacesDecoration
import kg.nurtelecom.design.chili3.adapter.IconTitledAdapter
import kg.nurtelecom.design.chili3.databinding.ChiliExpandableGridRecyclerViewBinding
import kg.nurtelecom.design.chili3.model.ExpandableGridItem

class ExpandableGridRecyclerView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = kg.nurtelecom.design.chili2.R.attr.expandableContainerViewStyle,
    defStyleRes: Int = kg.nurtelecom.design.chili2.R.style.Chili_Container_ExpandableContainerViewStyle
