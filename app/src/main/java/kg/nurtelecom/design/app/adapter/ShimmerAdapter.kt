...
import kg.nurtelecom.design.chili2.extensions.setHorizontalMargin
import kg.nurtelecom.design.chili2.view.adapter.BaseAdapter
import kg.nurtelecom.design.chili2.view.adapter.BaseViewHolder
    ...
    class ItemViewHolder(private val binding: ItemSimpleTextBinding) : BaseViewHolder<String?>(binding.root) {
        override fun onBind(item: String?, isLast: Boolean) {
            ...
            binding.root.apply {
                ...
                setBottomMargin(resources.getDimension(kg.nurtelecom.design.chili2.R.dimen.padding_8dp).toInt())
            }
        }
    }
