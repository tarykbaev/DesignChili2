...
import kg.nurtelecom.design.chili2.view.input.otp.OnOtpCompleteListener
import kg.nurtelecom.design.chili2.view.input.otp.OtpItemState
...
class InputFields : BaseFragment<FragmentInputFieldsBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vb.input57.setupOnGetFocusAction {
            ...
            vb.inputSv.smoothScrollTo(0, vb.input57.bottom + resources.getDimensionPixelSize(kg.nurtelecom.design.chili2.R.dimen.padding_16dp))
        }
