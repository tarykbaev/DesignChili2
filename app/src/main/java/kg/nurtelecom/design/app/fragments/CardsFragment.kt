...
import kg.nurtelecom.design.app.StoryActivity
import kg.nurtelecom.design.app.adapter.ShimmerAdapter
import kg.nurtelecom.design.app.adapter.SimpleDiscountCardRecyclerViewAdapter
...
import kg.nurtelecom.design.chili2.extensions.setScrollListener
import kg.nurtelecom.design.chili2.view.container.ExpandableContainer
import kg.nurtelecom.design.chili2.view.image.AutoScrollCarouselImageAdapter
...
import kg.nurtelecom.design.chili3.model.MyConnectionProfile
import kg.nurtelecom.design.chili3.model.PackageLeftOver
import kg.nurtelecom.design.chili3.model.PackageType
import kg.nurtelecom.design.chili3.util.StoriesStatus
import kg.nurtelecom.design.chili3.view.card.DividerCardSection
import kg.nurtelecom.design.chili3.view.card.HtmlTextPart
import kg.nurtelecom.design.chili3.view.card.InfoBlockCardView
import kg.nurtelecom.design.chili3.view.card.TagData
...
//        }, 4000)
        ...
        vb.bal4.apply {
            setValueText("2435 c")
            setValueIcon(kg.nurtelecom.design.chili2.R.drawable.chili_ic_warning)
        }
        ...
        vb.bankingCardView.apply {
            setCardBackground("https://devminio.o.kg/media-service/Bonus/ky/0d6780b9-cbf6-41a7-8750-4da9d7688715.jpg",
                placeholder = ContextCompat.getDrawable(context, kg.nurtelecom.design.chili2.R.drawable.bank_card_shimmer))
            setCardPan("9417 1243 3425 4215")
            setPanPinFieldYOffset(25.dp)
            setCardCvv("321")
        }
...
//        ), {}, {})
        ...
        vb.iconStateCardView.apply {
            setupAsErrorState(kg.nurtelecom.design.chili2.R.drawable.chili_ic_warning)
        ...
        vb.pcvProduct.apply {
            ...
            setProductImage("https://cdn.omarket.kg/ads-minify/XBxctjZWlSKjq9pgazTZoEOPh45SXToHMckuX1Ce7Rnb3egueT.WEBP",
                context.getColor(kg.nurtelecom.design.chili2.R.color.white_1))
        }
        ...
        vb.pcvProduct6.apply {
            ...
            setTags(tags)
            setTitleTextAppearance(kg.nurtelecom.design.chili3.R.style.Chili_H16_Primary_700)
            setSubtitleParts(
                listOf(
        ...
        vb.cardSections1.setSections(
            sectionList = listOf(
                ...
                DividerCardSection(
                    ...
                    subtitleTextAppearance = kg.nurtelecom.design.chili3.R.style.Chili_H16_AccentSecondary_Bold
                )
            )
        )
        ...
        pbcvElcap.apply {
            setOnClickListener {
                ...
                if (isElcapSubtitleShimmerShow) {
                    ...
                    setSubtitleColor(kg.nurtelecom.design.chili2.R.color.magenta_1)
                    setSubtitleContainerBackground(R.drawable.bg_rounded_white_with_paddings)
                    onStartShimmer()
                } else {
                    setSubtitleText("Apply card right now")
                    setSubtitleColor(kg.nurtelecom.design.chili2.R.color.white_1)
