...
import kg.nurtelecom.design.chili2.view.card.IconHolderCardItemView
            ...
            holder.discountCard.apply {
                when(position % 3){
                    ...
                    1 -> {
                        ...
                        setColor(kg.nurtelecom.design.chili2.R.color.green_1)
                    }
                    2 -> {
                        setTitle("Card Custom $position")
                        setEmoji(String(Character.toChars(128515)))
                        setColor(kg.nurtelecom.design.chili2.R.color.red_1)
                    }
                }
            }
        }
