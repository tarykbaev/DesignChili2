...
import kg.nurtelecom.design.app.adapter.SampleRadioItem
import kg.nurtelecom.design.app.adapter.SelectorAdapter
import kg.nurtelecom.design.app.adapter.SimpleTextRecyclerViewAdapter
import kg.nurtelecom.design.app.base.BaseFragment
import com.design2.app.databinding.FrgmentBottomSheetsBinding
import kg.nurtelecom.design.chili2.extensions.dp
import kg.nurtelecom.design.chili2.extensions.setOnSingleClickListener
import kg.nurtelecom.design.chili2.view.modals.base.BaseFragmentBottomSheetDialogFragment
import kg.nurtelecom.design.chili2.view.modals.bottom_sheet.*
...
import kg.nurtelecom.design.chili2.view.modals.bottom_sheet_constructor.BottomSheetConfig
import kg.nurtelecom.design.chili2.view.modals.bottom_sheet_constructor.Margins
import kg.nurtelecom.design.chili2.view.modals.bottom_sheet_constructor.Size
import kg.nurtelecom.design.chili2.view.modals.bottom_sheet_constructor.buildBottomSheet
import kg.nurtelecom.design.chili2.view.modals.in_app.InAppPushBottomSheet
import com.google.android.material.bottomsheet.BottomSheetBehavior
import com.google.android.material.bottomsheet.BottomSheetDialogFragment
import kg.nurtelecom.design.chili3.view.container.BottomSheetWithRecycler
    ...
    val customBS2: BottomSheetDialogFragment by lazy {
        requireContext().buildBottomSheet(BottomSheetConfig(isTopDrawableVisible = true)) {
            block(Gravity.CENTER, LinearLayout.VERTICAL) {
                image(kg.nurtelecom.design.chili2.R.drawable.chili_ic_done, size = Size(
                    widthMatchParent = true, heightDimenRes = kg.nurtelecom.design.chili2.R.dimen.view_64dp
            ...
            block(Gravity.CENTER, LinearLayout.HORIZONTAL, isPinnedBlock = true) {
                button(
                    ...
                    buttonStyle = kg.nurtelecom.design.chili2.R.style.Chili_ButtonStyle_Additional,
                ...
                button(
                    ...
                    buttonStyle = kg.nurtelecom.design.chili2.R.style.Chili_ButtonStyle_Primary,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        customBS1 = requireContext().buildBottomSheet(BottomSheetConfig()) {
            block(Gravity.CENTER, LinearLayout.VERTICAL) {
                ...
                text(
                    ...
                    textAppearance = kg.nurtelecom.design.chili2.R.style.Chili_H8_Primary_Bold,
                    isCentered = true,
                ...
                text(
                    ...
                    textAppearance = kg.nurtelecom.design.chili2.R.style.Chili_H8_Primary,
                    isCentered = true,
        ...
        vb.info.setOnClickListener {
            InfoBottomSheet.Builder()
                ...
                .setTextMaxLines(7)
                .setMessageTextAppearance(kg.nurtelecom.design.chili2.R.style.Chili_H4_Error)
...
//                .setDismissEvent { Toast.makeText(context, "Dismissed", Toast.LENGTH_SHORT).show() }
        ...
        vb.detail.setOnClickListener {
            DetailedInfoBottomSheet.Builder()
                ...
                .setIconSizeDimenRes(kg.nurtelecom.design.chili2.R.dimen.view_72dp)
        ...
        vb.detailDesc.setOnClickListener {
            DetailedDescriptionBottomSheet.Builder()
                .setIcon(R.drawable.ic_cat)
                .setIconSizeDimenRes(kg.nurtelecom.design.chili2.R.dimen.view_32dp)
        ...
        vb.chili3BottomSheetWRecview.setOnClickListener {
            ...
            bsh = BottomSheetWithRecycler.Builder()
                ...
                .setSubtitle("Тут можно задать стиль тексту")
                .setAdapter(adapter)
                .setSubtitleAppearance(kg.nurtelecom.design.chili2.R.style.Chili_H9_Error)
                .build()
        ...
        vb.chili3BottomSheetWInput.setOnSingleClickListener {
            FragmentBottomSheet.Builder()
                ...
                .setBottomSheetStyle(kg.nurtelecom.design.chili2.R.style.Chili_AdjustResizeBottomSheet)
                .setIsHideable(true)
        ...
        vb.customWithBuilder.setOnClickListener {
            FragmentBottomSheet.Builder()
                ...
                .setIsBackButtonEnabled(true)
                .setHorizontalMargin(resources.getDimension(kg.nurtelecom.design.chili2.R.dimen.padding_16dp).toInt())
                .setBottomMargin(resources.getDimension(kg.nurtelecom.design.chili2.R.dimen.padding_16dp).toInt())
                .setState(BottomSheetBehavior.STATE_EXPANDED)
                .setIsHideable(true)
                .setSkipCollapsed(false)
                .build()
        ...
        vb.detailCustom.setOnClickListener {
            DetailedInfoBottomSheet.Builder()
                ...
                .setIconSizeDimenRes(kg.nurtelecom.design.chili2.R.dimen.view_64dp)
