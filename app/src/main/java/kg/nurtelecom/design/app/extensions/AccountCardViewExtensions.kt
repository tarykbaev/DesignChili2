package kg.nurtelecom.design.app.extensions

import com.design2.app.R
import kg.nurtelecom.design.chili3.R as R3
import kg.nurtelecom.design.chili3.view.card.AccountCardView
...
fun AccountCardView.setFavoritePaymentAmountAvailableState(
    ...
    setTitleIcon(R3.drawable.chili_ic_star_16)
