...
import kg.nurtelecom.design.chili2.extensions.setOnDragDropListener
import kg.nurtelecom.design.chili2.view.container.grouping_rv.BaseGroupingVH
import kg.nurtelecom.design.chili2.view.container.grouping_rv.GroupableAdapter
import kg.nurtelecom.design.chili2.view.container.grouping_rv.GroupingItem
import kg.nurtelecom.design.chili2.view.container.grouping_rv.GroupingRVAdapter
import kg.nurtelecom.design.chili2.view.container.grouping_rv.ItemsStateMode
import kg.nurtelecom.design.chili2.view.container.grouping_rv.ShadowGroupItems
...
class ItemsAdapter : RecyclerView.Adapter<PoleItemVH>(), GroupableAdapter,
    DragAndDropCallbackListener, PoleItemAdapterListener {
...
class PoleItemVH(val vb: ItemPoleItemBinding) : RecyclerView.ViewHolder(vb.root) {
    ...
    fun onBind(item: PoleItem, isFirst: Boolean, isLast: Boolean, isEditing: Boolean) {
        ...
        vb.bcv.findViewById<ImageView>(kg.nurtelecom.design.chili2.R.id.iv_chevron).setOnDragDropListener {
