...
import kg.nurtelecom.design.app.adapter.EditableCellViewsAdapter
...
import kg.nurtelecom.design.chili2.util.RoundedCornerMode
import kg.nurtelecom.design.chili2.view.container.shadow_layout.model.ShadowType
...
import kg.nurtelecom.design.chili3.view.cells.CardCellView
...
class CellViewsFragment : BaseFragment<FragmentCellBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vb.dcv1.setValueTextColor(resources.getColor(kg.nurtelecom.design.chili2.R.color.red_1))
        ...
        vb.atcvWithLongText.apply {
            ...
            setAdditionalTextTextAppearance(kg.nurtelecom.design.chili3.R.style.Chili_H16_Success)
        }
        ...
        vb.multiiconedCellView.apply {
            ...
            setIconsTopMargin(kg.nurtelecom.design.chili2.R.dimen.view_12dp)
            setOnItemClicked {
        ...
        vb.checkboxWithEndText.apply {
            setTitleTextAppearance(kg.nurtelecom.design.chili2.R.style.Chili_H7_Value)
            setSubtitle("Тазалык 30402340234")
            setSubtitleTextAppearance(kg.nurtelecom.design.chili2.R.style.Chili_H7_Value)
        ...
        vb.cardcell5.apply {
            ...
            setAdditionalTextAppearance(kg.nurtelecom.design.chili3.R.style.Chili_H14_Primary)
        }
        vb.cardcell7.apply {
            setAdditionalText("Test Center Vertical", true)
            setIsUniqueStated(false)
        }
        vb.aicvHalykNoCommission.setSubtitleBackground(kg.nurtelecom.design.chili3.R.drawable.bg_subtitle_background_rounded)
