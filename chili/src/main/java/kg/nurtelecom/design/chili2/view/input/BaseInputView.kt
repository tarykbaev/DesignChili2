package kg.nurtelecom.design.chili2.view.input
...
import kg.nurtelecom.design.chili2.databinding.ChiliViewInputBaseBinding
import kg.nurtelecom.design.chili2.extensions.*
import kg.nurtelecom.design.chili2.extensions.gone
import kg.nurtelecom.design.chili2.extensions.visible
import kg.nurtelecom.design.chili2.util.CompositeOnFocusChangeListener
import kg.nurtelecom.design.chili2.util.ChiliKeyboardKeyEventListener
import kg.nurtelecom.design.chili2.util.cyrillicRegex
import kg.nurtelecom.design.chili2.view.input.text_watchers.ClearTextIconTextWatcher
import kg.nurtelecom.design.chili2.view.input.text_watchers.SimpleTextWatcher
import com.google.android.material.textfield.TextInputLayout
import kg.nurtelecom.design.chili2.extensions.setOnDoubleClickListener
...
open class BaseInputView @JvmOverloads constructor(
    ...
    protected var messageText: CharSequence? = null
    ...
    override fun onRestoreInstanceState(state: Parcelable?) {
        ...
        (state as? Bundle)?.let { bundle ->
            ...
            superState = bundle.getParcelable(kg.nurtelecom.design.chili2.view.input.BaseInputView.Companion.SUPER_STATE)
        }
    ...
    override fun onSaveInstanceState(): Parcelable? {
        ...
        return Bundle().apply {
            ...
            putParcelable(kg.nurtelecom.design.chili2.view.input.BaseInputView.Companion.SUPER_STATE, supperState)
        }
    }
    ...
    fun getInputField(): kg.nurtelecom.design.chili2.view.input.SelectionEditText {
        return vb.etInput
    }
    ...
    private fun setInputContainerClickListener() {
        vb.tilInputContainer.setOnClickListener {
            setSelectionToEnd()
            requestInputFocus()
            if (vb.etInput.showSoftInputOnFocus) showKeyboard()
        }
    }
    ...
    fun setMessage(text: String?) {
        setMessageSequence(text)
    }

    fun setMessageSequence(text: CharSequence?) {
        messageText = text
    ...
    fun clearFieldError() {
        ...
        setMessageSequence(messageText)
        isErrorShown = false
    }
    ...
    fun setPasteTextListener(onPasteListener: kg.nurtelecom.design.chili2.view.input.PasteListener) {
