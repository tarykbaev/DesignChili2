package kg.nurtelecom.design.chili2.view.modals.bottom_sheet
...
import kg.nurtelecom.design.chili2.databinding.ChiliViewBottomSheetInfoBinding
...
import kg.nurtelecom.design.chili2.view.modals.base.BaseViewBottomSheetDialogFragment
...
class InfoBottomSheet private constructor(): BaseViewBottomSheetDialogFragment() {
    ...
    private var textTextAppearance: Int? = null
    ...
    private fun setupViews() {
        ...
        textTextAppearance?.let { vb.tvText.setTextAppearance(it) }
    ...
    class Builder {
        ...
        fun setMessageTextAppearance(@StyleRes textAppearance: Int): Builder {
            this.textTextAppearance = textAppearance
            return this
        }
        ...
        fun build(): InfoBottomSheet {
            return InfoBottomSheet().apply {
                ...
                this.textTextAppearance = this@Builder.textTextAppearance
