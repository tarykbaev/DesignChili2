...
import kg.nurtelecom.design.chili2.view.input.text_watchers.LimitedInputLinesWatcher

class MultilineInputView : kg.nurtelecom.design.chili2.view.input.BaseInputView {
