...
import kg.nurtelecom.design.chili2.databinding.ChiliViewStoriesBinding
import kg.nurtelecom.design.chili2.view.stories.adapter.ChiliStoryPageTransformer
import kg.nurtelecom.design.chili2.view.stories.adapter.ChilliStoryPagerAdapter
    ...
    fun moveToPreviousPage() {
        viewPager?.let {
            ...
            if (currentItem > 0) {
                ...
                it.setCurrentItem(prevItem, false)
            }
        }
    }
}